---
title: "Teste de compração de médias"
output:
  html_document:
    df_print: paged
---
...
$$y_{ij} = \mu + \tau_i + e_{ij} = \mu_i + e_{ij},$$
		em que $e_{ij} \stackrel{iid}{\sim}  N(0, \sigma^2)$.
...
### Teste t-Student com correção de Bonferroni
```{r}
LSD.b <- with(dadosC,
LSD.test(y = prod,
trt = Genotipo,
...
+ sqrt(anova(modelo.lmC)[2,3]/4)
 
 # usando a biblioteca DescTools
