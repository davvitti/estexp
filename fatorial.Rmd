...
\ {Esquema fatorial: Introdução}
\begin{block}{Exemplo 1: Avaliação do efeito da adubação NPK sobre uma determinada cultura}
	$$\left.\begin{array}{l}
	\mbox{N com 2 níveis}\\ \nonumber
	\mbox{P com 2 níveis}\\ \nonumber
	\mbox{K com 2 níveis} \nonumber
...
\begin{center}
\begin{tabular}{cccc}
	$N_0P_0K_0$ & $N_0P_0K_1$ & $N_0P_1K_0$ & $N_0P_1K_1$ \\
    $N_1P_0K_0$ & $N_1P_0K_1$ & $N_1P_1K_0$ & $N_1P_1K_1$ \\
\end{tabular}
\end{center}
\end{block}
...
\ {Esquema fatorial: Introdução}
	\begin{block}{Exemplo 2: Avaliação da Temperatura e da Umidade sobre o tempo de conservação de um produto}
		
		
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.5]{Figuras/fatorial32.jpg}
		\end{figure}
		$$3 \times 2 = \mbox{6 Tratamentos}$$
...
\end{itemize}
\begin{center}
    \includegraphics[scale = 0.4]{Aulas/Figuras/Fatorial_dic.jpeg}
\end{center}
...
O planejamento pode seguir qualquer um dos delineamentos vistos anteriormente:
\begin{itemize}
	\item Delineamento Casualizado em Blocos
\end{itemize}
\begin{center}
    \includegraphics[scale = 0.4]{Aulas/Figuras/Fatorial_dbc.jpeg}
\end{center}
...
O planejamento pode seguir qualquer um dos delineamentos vistos anteriormente:
\begin{itemize}
	\item Delineamento Quadrado Latino
\end{itemize}
\begin{center}
    \includegraphics[scale = 0.4]{Aulas/Figuras/Fatorial_dql.jpeg}
\end{center}
...
\end{block}
{1cm}
{\bf Observação:} As combinações dos níveis dos fatores serão casualizadas às parcelas, de acordo com o delineamento experimental selecionado.



\ {Esquema fatorial: Introdução}
	\begin{block}{Vantagens e Desvantagens dos esquemas fatoriais de tratamentos}
		
{\bf {0, .5,1}{Vantagens:}} Permitem estudar os efeitos simples e principais dos fatores, bem como o efeito da interação envolvendo os mesmos.

{.5cm}

{\bf {0, .5,1}{Desvantagens:}} O número de tratamentos pode ser elevado devido ao número de fatores e/ou ao número de níveis dos fatores.
...
\ {Esquema fatorial: Introdução}
	\begin{block}{Fatoriais $2\times 2$ ou $2^2$}
...
\end{center}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[scale=0.4]{Figuras/fatorial22.jpg}
			\end{figure}	
...
\begin{block}{Análise exploratória gráfica: exemplo 1}
	...
	\begin{multicols}{2}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.4]{Figuras/Fatorial_fig1.pdf}
		\end{figure}
...
\begin{block}{Análise exploratória gráfica: exemplo 2}
...
\begin{block}{Análise exploratória gráfica: exemplo 3}
...
\begin{block}{Análise exploratória gráfica: exemplo 4}
...
\begin{block}{Análise exploratória gráfica: exemplo 5}
...
\begin{block}{Análise exploratória gráfica: exemplo 6}
...
\begin{block}{Soma de quadrados de Irrigação}
...
\begin{block}{Soma de quadrados de Calagem}
...
\begin{block}{Soma de quadrados da combinação Irrigação,Calagem (Tratamentos)}
...
\begin{block}{Soma de quadrados da Interação Irrigação$\#$Calagem}
